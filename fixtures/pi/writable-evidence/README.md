...
- `project/.pi/skills/project-evidence-toggle/SKILL.md` models a project-level guarded toggle.
...
- `config/pi-settings.untrusted-project.json` models an explicit-untrusted marker that must block project/package writes.
