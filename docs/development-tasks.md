...
> Status: V2.53 Similar Skill Grouping is completed and synchronized on `main`; V2.1 through V2.53 are synchronized baseline; V2.54 capability taxonomy is the next roadmap line.
