...
> Status: V2.51 Stale / Drift Detection is completed and synchronized on `main`; V2.1 through V2.51 are synchronized baseline; V2.52+ remains the next roadmap line, not separate product branches.
