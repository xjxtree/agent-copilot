...
> Status: V2.53 Similar Skill Grouping is completed and synchronized on `main`; V2.1 through V2.53 are synchronized baseline; V2.54 capability taxonomy is the next planned docs-prep line and remains unvalidated in this branch.
...
| V2.54 | Capability Taxonomy | Planned | Intended `knowledge.buildCapabilityTaxonomy` docs-prep shape: deterministic, local, read-only capability-domain grouping over existing evidence; not yet implemented or validated |
