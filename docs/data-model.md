...
- `RemediationHistory`（V2.60 future）：local review history state with actions considered, decisions, reopened issues, impact notes, and summary. AI suggestions remain untrusted and cannot directly mutate skill files or agent config.
