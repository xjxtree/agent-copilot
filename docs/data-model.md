...
- `WorkspaceReadiness`（V2.55 planned）：future derived readiness view over existing catalog / taxonomy / task readiness evidence; planned entry point is `workspace.checkReadiness`; local, user-triggered, deterministic, and read-only by default.
