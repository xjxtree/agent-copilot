...
The AI-native line introduces analysis models incrementally and evidence-first. V2.41 adds app-data provider profile metadata and Keychain credential references, V2.61 adds redacted prompt run history, V2.62 adds app-local redacted Agent Session Skill Review metadata, and V2.63 adds a derived Local Skill Map response. The remaining planned models cover Provider Observability, Task-first Cockpit, Skill Lifecycle Timeline, and Guided Cleanup Flow.
