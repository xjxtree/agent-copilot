...
| V2.60 | Remediation History | Future: record local remediation decisions, recurrence, reopened issues, and readiness improvements without adding automatic writes. |
