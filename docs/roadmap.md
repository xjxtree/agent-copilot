...
V2.81 and V2.82 are completed with code, focused tests, docs, shared gates, and documented no-new-UI validation decisions. V2.83 remains planned and becomes completed only after code, tests, docs, and required validation evidence prove the behavior.
