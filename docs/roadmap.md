...
| V2.54 | Capability Taxonomy | Planned docs-prep: intended local, deterministic, read-only capability-domain grouping over existing evidence; not yet implemented or validated. |
