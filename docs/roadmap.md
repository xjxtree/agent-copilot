...
V2.81 is completed with code, focused cancellation tests, docs, shared gates, and a documented no-new-UI validation decision. V2.82-V2.83 remain planned. They become completed only after code, tests, docs, and required validation evidence prove the behavior.
