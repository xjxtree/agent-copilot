...
V2.80 is completed with code, tests, docs, shared gates, and fresh unlocked real-local Computer Use evidence. V2.81-V2.83 remain planned. They become completed only after code, tests, docs, and required validation evidence prove the behavior.
