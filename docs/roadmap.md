...
| V2.57 | Fix Preview Drafts | Planned: user-triggered, local-only/deterministic-by-default draft suggestions for frontmatter, description, permissions, dependency, and policy; copy/edit-ready only, with no direct apply/write path. |
