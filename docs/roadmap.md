...
| V2.58 | Impact Preview | Future: preview task, agent, skill, snapshot, and rollback impact plus risk changes before enable/disable/edit/remediation. |
