...
| V2.55 | Workspace Readiness Check | Planned `workspace.checkReadiness`; evaluate current workspace skills per agent for completeness, scope fit, and risk control, then surface a readiness checklist without default provider calls or writes. |
