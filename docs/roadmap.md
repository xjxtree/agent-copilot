...
| V2.59 | Batch Review Workflow | Future: batch review by task, risk, rule, agent, and workspace; write paths stay preview-first and explicit-confirm only. |
