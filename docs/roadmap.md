...
| V2.56 | AI Remediation Planner | Service/protocol slice 已完成：`remediation.plan` 将 findings、gap、routing ambiguity、drift、readiness、taxonomy、workspace evidence 转成优先级明确的只读处理计划；native UI 仍后续。 |
