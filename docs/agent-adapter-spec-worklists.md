...
Pi, Hermes, and OpenClaw remain blocked or read-only planning until their evidence gates are satisfied. Opencode writable is enabled for native roots after V2.12 validation; Pi, Hermes, and OpenClaw remain blocked until their evidence gates are satisfied.
