...
- 把复杂分析、任务可用性、routing 置信度、trace 判断、remediation、真实 agent session skill review、本地 skill map、provider observability、task-first cockpit、skill lifecycle timeline 与 guided cleanup 提升为 AI-native 能力；用户可显式配置 OpenAI-compatible / Claude-compatible provider。
