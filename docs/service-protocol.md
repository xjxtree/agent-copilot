...
## V2.41-V2.70 AI-native protocol planning
...
| V2.46-V2.47 | `task.benchmark.*`, `task.detectRoutingRegression` | App-local benchmark definitions and deterministic/AI-assisted regression analysis |
| V2.48-V2.49 | `trace.importLocal`, `trace.analyzeRoutingAccuracy`, `routing.dashboard` | Local trace import with redaction; no raw credential/log persistence |
