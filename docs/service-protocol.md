...
- Not yet integrated: V2.51 stale/drift detection and full V2.69 provider observability UX over call metadata.

V2.51+ planning starts from the V2.50 completed protocol surface below.
...
| V2.51-V2.55 | `(planned) knowledge.search`, `(planned) knowledge.groupSimilarSkills`, `(planned) workspace.checkReadiness` | Local index/readiness views; no default network |
