...
- Not yet integrated: V2.52 local knowledge index and full V2.69 provider observability UX over call metadata.

V2.52+ planning starts from the V2.51 completed protocol surface below.
...
| V2.52-V2.55 | `(planned) knowledge.search`, `(planned) knowledge.groupSimilarSkills`, `(planned) workspace.checkReadiness` | Local index/readiness views; local evidence-first, no default network |
