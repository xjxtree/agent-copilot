...
const requiredAgentsSnippets = [
  "Current phase: **V2.81 Swift stdio sidecar cancellation cleanup completed**",
...
const requiredDevelopmentSnippets = [
  "Status: V2.81 Swift IPC cancellation cleanup is complete.",
  "V2.1 through V2.81 are the synchronized completed baseline",
...
for (const [text, label] of [
  ...
  rejectRegex(text, label, /V2\.81\s+.*in progress/i, "V2.81 in-progress claim");
  rejectRegex(text, label, /V2\.81\s+.*scaffold/i, "V2.81 scaffold claim");
