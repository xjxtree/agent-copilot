...
const requiredReferenceChecks = [
  ...
  [readme, "README.md", "V2.86 Rust helper/test split and module-size gate closeout completed"],
  ...
  [roadmap, "docs/roadmap.md", "V2.86 Rust helper/test split and module-size gate closeout completed"],
