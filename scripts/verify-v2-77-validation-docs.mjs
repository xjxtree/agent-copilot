...
const requiredReferenceChecks = [
  ...
  [readme, "README.md", "V2.78-V2.79 remain planned"],
  ...
  [developmentTasks, "docs/development-tasks.md", "V2.78 remains planned"],
  ...
  [roadmap, "docs/roadmap.md", "V2.78-V2.79 remain planned"],
