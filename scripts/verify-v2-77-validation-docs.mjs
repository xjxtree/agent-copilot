...
const requiredReferenceChecks = [
  ...
  [readme, "README.md", "V2.78-V2.83 remain planned"],
  ...
  [developmentTasks, "docs/development-tasks.md", "V2.78-V2.83 remain planned"],
  ...
  [roadmap, "docs/roadmap.md", "V2.78-V2.83 remain planned"],
