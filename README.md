...
**当前阶段**：V2.83 continued module splitting completed. V2.1-V2.83 is the synchronized completed baseline; V2.83 completes the V2.78-V2.83 consolidation line with refactor-only Rust/Swift module extraction, split-file verifier parity, and unchanged service protocol / native UI semantics.
...
**下一版本线**：V2.78-V2.83 consolidation line completed. No post-V2.83 version has been selected yet.
...
| `pnpm verify:gate-parity` | Gate parity lane：把 protocol drift、V2.73-V2.83 docs verifiers、validation blocker verifier 和 screenshot artifact verifier 串成 CI/local 共享的 deterministic gate。 |
